...
public class MainActivity extends AppCompatActivity {
    ...
    private RelativeLayout rl_chatBot2;//////////////
    private ImageView mAvatarIcon;
    private ImageView trash;
    private ImageView mAvatarIcon2;/////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_chatBot2 = (RelativeLayout) findViewById(R.id.rl_chatBot2);/////////////////
        mAvatarIcon2 = findViewById(R.id.bn_avatar2);/////////////////////

        trash = findViewById(R.id.trash);

        mAvatarIcon.setOnTouchListener(new MoveViewTouchListener(rl_chatBot));

        mAvatarIcon2.setOnTouchListener(new MoveViewTouchListener(rl_chatBot2));/////////////////////////////
